	...
	class Message{
		...
		public function getLatestMessage($userLoggedIn,$user2){
			...
			//timeframe
					...
					else if($interval->m >=1){  //provjera dana i mjeseci , sati i sekundi
							if($interval->d == 0){
								$days = " ago";
							}
							else if($interal->d == 1){
		...
		public function getConvos(){
			...
			foreach($convos as $username){
				...
				$return_string .= "<a href='messages.php?u=$username'><div class='user_found_messages'>
									 <img src='"  . $user_found_obj->getProfilePic() ."' style='width:100px; height:100px; border-radius:5px; margin-right:5px;
									 ' class='img_user_found_messages'>
		...
		public function getConvosDropdown($data,$limit){
			...
			$num_iterations = 0; //numbers of messages checked
